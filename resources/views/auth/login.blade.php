  ...
  <div class="bg-white lg:w-5/12 md:6/12 w-10/12 shadow-3xl">
    ...
    <form class="p-12 md:p-24" method="POST" action="{{ route('login') }}">
      ...
      <div class="flex items-center text-lg mb-6 md:mb-8">
        ...
        <input type="text" id="email" class="bg-gray-200 pl-12 py-2 md:py-4 focus:outline-none w-full" name="email" value="{{ old('email') }}" required autocomplete="email" autofocus placeholder="Email Address">
      </div>
      <div class="flex items-center text-lg mb-6 md:mb-8">
...
<!--                                     
      ...
      <button type="submit" class="bg-black font-medium p-2 md:p-4 text-white uppercase w-full">Login</button>
    </form>
  </div>
</div>
@endsection
